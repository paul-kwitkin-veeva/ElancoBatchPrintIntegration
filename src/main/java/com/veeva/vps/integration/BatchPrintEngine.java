...
import com.veeva.vps.integration.services.VpsSettingsService;
...
public class BatchPrintEngine {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			//FileInputStream in = new FileInputStream( "/printintegration.properties");
...
//				String namedef = service.getName();
//				logger.debug("ServiceDef name: " + namedef);
